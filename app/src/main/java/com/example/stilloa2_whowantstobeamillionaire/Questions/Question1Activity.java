...
/*
NOTE: I added some functionalities beyond what was required by the assignment. This includes the
user's winnings dropping to their last checkpoint if they get a question incorrect, and a button for
the user to take their earnings and give up.

I would also like to mention that this could be much more efficient, but since the rubric explicitly
said 10 activities, I implemented them as activities. This could be done with one activity class and
a model class for a Question object, and simply refreshing the activity and passing the question number
between questions. Nonetheless, this implementation is in line with the specifications.
 */
...
public class Question1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        questionView.setText(R.string.q1);
        rb1.setText(R.string.q1c1);
        rb2.setText(R.string.q1c2);
        rb3.setText(R.string.q1c3);
        rb4.setText(R.string.q1c4);
    }
