...
public class Question14Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        questionView.setText(R.string.q14);
        rb1.setText(R.string.q14c1);
        rb2.setText(R.string.q14c2);
        rb3.setText(R.string.q14c3);
        rb4.setText(R.string.q14c4);
    }
    ...
    public void onClick(View V) {
        ...
        if (!rb1.isChecked() && !rb2.isChecked() && !rb3.isChecked() &&
            ...
            Intent intent = new Intent(this, Question15Activity.class);
