...
import com.example.stilloa2_whowantstobeamillionaire.VictoryActivity;
...
public class Question15Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        questionView.setText(R.string.q15);
        rb1.setText(R.string.q15c1);
        rb2.setText(R.string.q15c2);
        rb3.setText(R.string.q15c3);
        rb4.setText(R.string.q15c4);
    }
    ...
    public void onClick(View V) {
        ...
        if (!rb1.isChecked() && !rb2.isChecked() && !rb3.isChecked() &&
            ...
            score = 1000000;
            Toast toast = Toast.makeText(this, "Correct! You've earned $" + score +
                    "!!!! You've won the $1000000 prize!!!!", Toast.LENGTH_SHORT);
            toast.show();
