...
public class Question10Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        questionView.setText(R.string.q10);
        rb1.setText(R.string.q10c1);
        rb2.setText(R.string.q10c2);
        rb3.setText(R.string.q10c3);
        rb4.setText(R.string.q10c4);
    }
    ...
    public void onClick(View V) {
        ...
        if (!rb1.isChecked() && !rb2.isChecked() && !rb3.isChecked() &&
            ...
            Toast toast = Toast.makeText(this, "Correct! You've earned $" + score
                    + "! Wrong answers will now still earn you $32000!", Toast.LENGTH_SHORT);
            toast.show();
